...
def getfilenames():
    ...
    parser.add_argument("-output", type=str, help="path to output html/json files directory")
    parser.add_argument("--enable_html", action='store_true', default=False, help="enable html output")
    parser.add_argument("--enable_json", action='store_true', default=False, help="enable json output")
